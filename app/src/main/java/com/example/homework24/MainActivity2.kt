...
class MainActivity2 : AppCompatActivity() {
    ...
    private fun sendSMS() {
        ...
        if (text.isNotEmpty()) {
            ...
            Toast.makeText(this, "$name ga habar eson omon yetib bordi", Toast.LENGTH_SHORT).show()
        } else {
            Toast.makeText(this, "Iltimos habar yozing", Toast.LENGTH_SHORT).show()
        }
    ...
    private fun myMethod() {
        ...
        askPermission(Manifest.permission.SEND_SMS) { sendSMS() }.onDeclined { e ->
            ...
            if (e.hasForeverDenied()) {
                Snackbar.make(
                    binding.root,
                    "Agar bu funksiyani to'liq ishlatmoqchi bo'lsangiz ruhsat berishingiz kerak aks holda mendan o'pkalamang",
